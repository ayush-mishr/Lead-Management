...
export const Table = () => {
  ...
  const fetchLeads = async () => {
    try {
      const res = await axios.get("https://lead-management-qksg.onrender.com/api/v1/leads");
  ...
  const createLead = async () => {
    ...
    try {
      await axios.post("https://lead-management-qksg.onrender.com/api/v1/leads", newLead);
  ...
  const updateLead = async () => {
    ...
    try {
      await axios.put(
        `https://lead-management-qksg.onrender.com/api/v1/leads/${selectedLead._id}`,
        selectedLead
      );
